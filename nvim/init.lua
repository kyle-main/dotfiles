...
-- Split keymaps
vim.keymap.set('n', '<leader>hs', '<C-w><C-s>', { desc = 'Create new [H]orizontal [S]plit' })
vim.keymap.set('n', '<leader>vs', '<C-w><C-v>', { desc = 'Create new [V]ertical [S]plit' })
...
require('lazy').setup({
  ...
  { -- Highlight, edit, and navigate code
    ...
    build = ':TSUpdate',
    opts = {
      ensure_installed = { 'bash', 'c', 'diff', 'go', 'html', 'lua', 'luadoc', 'markdown', 'python', 'vim', 'vimdoc' },
